...
<section class="privacySection">
    <div class="container">
        <h1 class="mb-50">Privacy Policy</h1>
        <div class="content">
            <p>
                This privacy policy sets out how codegrand, uses and protects any information that you give codegrand
                when you use this website.
            </p>
            <p>
                codegrand is committed to ensuring that your privacy is protected. Should we ask you to
                provide
            ...
            <p>
                codegrand may change this policy from time to time by updating this page. You should check
                this
                page from time to time to ensure that you are happy with any changes.
            </p>
            <h3>What we collect.</h3>
            <p>
                Personal information means any information that may be used to identify an individual, including, but
                not
                limited to, a first and last name, email address, a home, postal or other physical address, other
                contact
                information, title, occupation, industry, personal interests, and other information when needed to
                provide a
                service or product or carry out a transaction you have requested.
            </p>
            ...
            <p>
                codegrand do not transfer or share your information except as provided below:
            </p>
            <p>
                codegrand may also send your personal information to other companies or people if:
            </p>
            <p>
                codegrand have users’ consent to share the information;
            </p>
            <p>
                codegrand may share User’s personally identifiable information with our resellers and partners, so that
                such
                resellers and partners may use such information to market codegrand ‘s products and services, and to market
                their own products and services. codegrand may engage certain trusted third parties to perform function and
                provide services to us, including without limitation, hosting and management services, customer
                relationship
                services, database storage and management services, fulfilling orders, sending email, processing credit
                card
                payments or other functions necessary to our business; and codegrand may share your personally identifiable
                information with these third parties, but only to the extent necessary to perform these functions and
                provide such services, and only pursuant to binding contractual obligations requiring such third parties
                to
                maintain confidentiality of your data.
            </p>
            <p>
                codegrand may also reveal a user’s identity or relevant information if codegrand knows or believes that User
                is
                harming or interfering with other our users, anyone else, or violating the Agreement or infringing any
                of
                the codegrand ‘s legal rights.
            </p>
            <p>
                codegrand may also reveal user’s personal information when required to do so by law, or if we have a
                good-faith
                belief that such action is necessary to comply with a court order or subpoena, to cooperate with
                investigations by law enforcement or regulatory authorities or to participate or cooperate with a
                judicial
                proceeding, or in urgent circumstances, to protect personal safety, the public or our websites; to
                protect
                the property and rights of codegrand or a third party, the safety of the public or any person; to prevent
                or
                stop any illegal, unethical or legally actionable activity.
            </p>
            <p>
                In the event of a merger, consolidation or reorganization involving codegrand , acquisition of codegrand by
                another company, or other similar transaction, your personal information will, in most instances, be
                transferred to the control of the third party that is part of that transaction.
            </p>
            <h3>Security.</h3>
            <p>
            ...
            <p>
                ...
                may
                change your mind at any time by writing to or emailing us at hello@codegrand.com
                ...
                this to
                happen. You may request details of personal information which we hold about you as governed by the laws
                of
                India. A small fee may be payable. If you would like a copy of the information held on you please write
                to
                codegrand, nehru nagar, kurla(East), Mumbai 4000240. If you believe that any
