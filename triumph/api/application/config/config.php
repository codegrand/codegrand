...
/*
  ...
  |
 */
$config['base_url'] = 'https://triumph.codegrand.com/api';
...
$config['is_live'] = 'live'; //live/demo


$config['BUINESS_SHORT_NAME'] = "Hero Corp Service";
$config['BUINESS_FULL_NAME'] = "Hero Corporate Service Private Limited ";
$config['BUINESS_EMAIL_ID'] = "heromf@herocorp.com";
$config['BUINESS_CONTACT_NUMBER'] = "";
$config['BUINESS_ADDRESS'] = "";
$config['BUINESS_MOBILE_NUMBER'] = "";
$config['BUINESS_LOGO'] = "";



/*echo $WSDL_ORDER_URL[$url];*/
 // $WSDL_ORDER_URL;
/*WSDL_ORDER_URL = [
